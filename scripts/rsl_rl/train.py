...
def _build_research_metadata(env_cfg) -> dict:
    ...
    return {
        ...
        "joint_gap_enabled": research.joint_gap.enabled,
        "joint_gap_lambda_joint": research.joint_gap.lambda_joint,
        "joint_gap_num_joints": research.joint_gap.num_joints,
        "joint_gap_ema_decay": research.joint_gap.ema_decay,
        "joint_gap_update_interval": research.joint_gap.update_interval,
        "joint_gap_min_observations": research.joint_gap.min_observations,
        "joint_gap_num_difficulty_bins": research.joint_gap.num_difficulty_bins,
        "joint_gap_positive_only": research.joint_gap.positive_only,
        "joint_gap_local_center": research.joint_gap.local_center,
        "joint_gap_aggregation": research.joint_gap.aggregation,
        "joint_gap_top_k": research.joint_gap.top_k,
        "joint_gap_raw_gate_enabled": research.joint_gap.raw_gate.enabled,
        "joint_gap_raw_gate_mode": research.joint_gap.raw_gate.mode,
        "joint_gap_transform": research.joint_gap.transform,
